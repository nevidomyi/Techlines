    ...
    <Stack spacing='8' borderWidth='1px' rounded='lg' padding='8' w='full' >
      ...
      <Stack spacing='6'>
        ...
        <Flex justify='space-between' align='center'>
          ...
          <Text fontSize='xl' fontWeight='extrabold'>
            ${subtotal <= 1000 ? Number(subtotal) + Number(standartShipping) : subtotal}
          </Text>
        </Flex>
      </Stack>
      <Button as={ReactLink} to='/checkout' colorScheme='orange' size='lg' fontSize='md' rightIcon={<FaArrowRight />} isLoading={buttonLoading} onClick={() => checkoutHandler()}></Button>
    </Stack>
  )
}
