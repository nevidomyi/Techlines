import { Modal, ModalOverlay, ModalContent, ModalBody, Button, Alert, AlertTitle, AlertIcon, Wrap, useToast, Stack } from '@chakra-ui/react'
            ...
            <Wrap justify='center' direction='column' align='center' mt='20px'>
              <Alert
                ...
                <Stack mt='20px' minW='200px'>
                  ...
                  <Button colorScheme='teal' variant='outline' as={ReactLink} to='/products'>Products</Button>
