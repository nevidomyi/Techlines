  ...
  return (
    <Wrap justify='center' >
      {loading ? (
        ...
        product && (
          <Wrap spacing='30px' maxW={{ base: '3xl', lg: '5xl' }} mx='auto' px={{ base: '4', md: '8', lg: '12' }} py={{ base: '6', md: '8', lg: '12' }}>
            <Stack direction={{ base: 'column', lg: 'row' }} align={{ lg: 'flex-start' }}>
              <Stack pr={{ base: '0', md: '12' }} spacing={{ base: '8', md: '4' }} flex='1.5' md={{ base: '12', md: 'none' }}>
                {product.productIsNew && (<Badge rounded="full" w='40px' fontSize='0.8em' colorScheme="green">New</Badge>)}
                {product.stock === 0 && (<Badge rounded="full" w='min-content' fontSize='0.8em' colorScheme="red">Sold out</Badge>)}
                ...
                <Stack spacing='5'>
                  ...
                  <Flex w='170px' p='5px' border='1px' borderColor='gray.200' justify="space-between" alignItems='center'>
                    <Button isDisabled={amount <= 1} onClick={() => changeAmount('minus')}>
                      <MinusIcon />
                    </Button>
                    <Text fontSize='lg' fontWeight='bold' ml='4px' >{amount}</Text>
